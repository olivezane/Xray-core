...
type Config struct {
	...
	LogKeepDays   uint32                 `protobuf:"varint,8,opt,name=log_keep_days,json=logKeepDays,proto3" json:"log_keep_days,omitempty"`
...
func (x *Config) GetLogKeepDays() uint32 {
	if x != nil {
...
const file_app_log_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/log/config.proto\x12\fxray.app.log\x1a\x14common/log/log.proto\"\x82\x03\n" +
	"\x06Config\x12;\n" +
	...
	"\rlog_keep_days\x18\b \x01(\rR\vlogKeepDays*5\n" +
	"\aLogType\x12\b\n" +
